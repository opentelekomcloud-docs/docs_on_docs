...
project = 'Documentation about documentation'
otcdocs_repo_name = 'opentelekomcloud-docs/docs_on_docs'
...
html_title = "Documentation about documentation - Service Based View"
